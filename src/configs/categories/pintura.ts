  ...
  steps: [
    // STEP 1: Decisão principal (sempre aparece)
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder:
            "Descreva detalhes específicos sobre o tipo de pintura que precisa...",
        },
      ],
    },
      ...
      fields: [
        {
          ...
          options: [
            ...
            {
              value: "acabamentos",
              label: "Acabamentos (rodapés, molduras, batentes)",
            },
            {
              value: "multiplas-areas",
              label: "Múltiplas áreas (paredes + teto + acabamentos)",
            },
          ],
        },
      ],
      ...
      fields: [
        {
          ...
          options: [
            ...
            {
              value: "pintura-parcial",
              label: "Pintura parcial (algumas áreas específicas)",
            },
            {
              value: "item-unico",
              label: "Item único (portão, porta, janela, etc.)",
            },
          ],
        },
      ],
    ...
    // SUB-FLUXO B1: Casa Completa - apenas material
    {
      ...
      showIf: (answers) => {
        const paintLocation = answers["paint-type"]?.["paint-location"];
        const exteriorScope =
          answers["exterior-scope"]?.["exterior-project-scope"];
      ...
      fields: [
        {
          ...
          options: [
            ...
            {
              value: "estruturas-ferro",
              label: "Estruturas de ferro (grades, portões, corrimãos)",
            },
            {
              value: "madeira-especial",
              label: "Madeira especial (decks, pergolados)",
            },
      ...
      fields: [
        {
          ...
          options: [
            {
              value: "profissional-fornece",
              label: "Profissional fornece o material",
            },
            { value: "cliente-fornece", label: "Eu forneço o material" },
            {
              value: "orcamento-separado",
              label: "Orçar material separadamente",
            },
          ],
        },
      ],
...

    {
      id: "contact-data",
      title:
        "Quase lá! Só precisamos dos seus dados para enviar os orçamentos:",
      ...
      fields: [
        ...
        // },
        {
          ...
          links: [{ text: "termos de uso", url: "/politica-privacidade" }],
        },
      ],
    },
  ],

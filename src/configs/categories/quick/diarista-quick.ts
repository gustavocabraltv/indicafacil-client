// configs/categories/quick/diarista-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const diarista_quick: MultistepConfig = {
  id: 'diarista-service',
  title: 'Serviço de Diarista',
  category: 'diarista',
  steps: [
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: frequência desejada, tipos de limpeza, tamanho do ambiente...)',
            required: false,
          },
        ],
      },

// configs/categories/quick/limpeza-domestica-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const limpeza_quick: MultistepConfig = {
  id: 'limpeza-domestica-service',
  title: 'Serviço de Limpeza Doméstica',
  category: 'limpeza-domestica',
  steps: [
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: tipo de limpeza, frequência, número de cômodos...)',
            required: false,
          },
        ],
      },

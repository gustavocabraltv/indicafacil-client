// configs/categories/quick/servico-de-encanamento-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const encanamento_quick: MultistepConfig = {
  id: 'servico-de-encanamento-service',
  title: 'Serviço de Encanamento',
  category: 'servico-de-encanamento',
  steps: [
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: vazamentos, instalações, reparos, localização do problema...)',
            required: false,
          },
        ],
      },

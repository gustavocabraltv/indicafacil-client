// configs/categories/quick/servico-de-calhas-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const calhas_quick: MultistepConfig = {
  id: 'servico-de-calhas-service',
  title: 'Serviço de Calhas',
  category: 'servico-de-calhas',
  steps: [
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: instalação, limpeza, reparo, metragem aproximada...)',
            required: false,
          },
        ],
      },

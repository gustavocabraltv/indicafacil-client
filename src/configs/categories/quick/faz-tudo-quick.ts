// configs/categories/quick/faz-tudo-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const faz_tudo_quick: MultistepConfig = {
  id: 'faz-tudo-service',
  title: 'Serviço de Faz Tudo',
  category: 'faz-tudo',
  steps: [
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: tipos de reparos, instalações, montagens...)',
            required: false,
          },
        ],
      },

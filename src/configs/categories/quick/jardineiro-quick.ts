// configs/categories/quick/jardineiro-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const jardineiro_quick: MultistepConfig = {
  id: 'jardineiro-service',
  title: 'Serviço de Jardineiro',
  category: 'jardineiro',
  steps: [
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: poda, plantio, manutenção, tamanho do jardim...)',
            required: false,
          },
        ],
      },

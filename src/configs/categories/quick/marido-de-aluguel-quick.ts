// configs/categories/quick/marido-de-aluguel-quick.ts
import { MultistepConfig } from '@/types/multistep';

export const marido_de_aluguel_quick: MultistepConfig = {
  id: 'marido-de-aluguel-service',
  title: 'Serviço de Marido de Aluguel',
        ...
        fields: [
          {
            ...
            placeholder: 'Conte um pouco mais sobre o projeto (ex.: tipos de reparos, montagem de móveis, instalações...)',
            required: false,
          },
        ],
      },
